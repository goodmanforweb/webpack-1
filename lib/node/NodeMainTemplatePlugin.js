									...
									[
										...
										.concat([
											...
											mainTemplate.indent([
												...
												mainTemplate.indent(["callbacks = callbacks.concat(installedChunks[chunkIds[i]][0]);"]),
				...
				return mainTemplate.asString([
					...
					mainTemplate.indent(
						[`var chunk = require(${request});`]
							.concat(insertMoreModules)
							.concat(["for(var i = 0; i < chunkIds.length; i++)", mainTemplate.indent("installedChunks[chunkIds[i]] = 0;")])
					),
					"}"
				]);
			}
