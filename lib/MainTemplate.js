...
module.exports = class MainTemplate extends Template {
	constructor(outputOptions) {
		...
		this.plugin("startup", (source, chunk, hash) => {
			...
			if (chunk.entryModule) {
				...
				buf.push(
					`return ${this.renderRequireFunctionForModule(hash, chunk, JSON.stringify(chunk.entryModule.id))}(${this.requireFn}.s = ${JSON.stringify(
		...
		this.plugin("require-extensions", (source, chunk, hash) => {
			...
			buf.push(
				this.indent([
					...
					this.indent(["Object.defineProperty(exports, name, {", this.indent(["configurable: false,", "enumerable: true,", "get: getter"]), "});"]),
					"}"
				])
			);
			buf.push("};");
			...
			buf.push(this.indent(["Object.defineProperty(exports, '__esModule', { value: true });"]));
			buf.push("};");
			...
			buf.push(
				this.indent([
					...
					this.indent(["function getDefault() { return module['default']; } :", "function getModuleExports() { return module; };"]),
	...
	getRenderManifest(options) {
		...
		if (chunk.filenameTemplate) filenameTemplate = chunk.filenameTemplate;
		else if (chunk.isInitial()) filenameTemplate = outputOptions.filename;
		else {
